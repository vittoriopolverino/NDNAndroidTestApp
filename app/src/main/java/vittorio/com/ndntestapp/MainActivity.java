...
public class MainActivity extends AppCompatActivity {
    ...
    private TextView ndnResponse;
    private TextView msgToClient;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ndnResponse = (TextView) findViewById(R.id.ndnResponse);
        msgToClient = (TextView) findViewById(R.id.msgToClient);
        ...
        if (isMyServiceRunning(SocketCommunicationService.class)) {
            serviceStatus.setText("is running on address " + mLocalAddress);
        } else {
            serviceStatus.setText("isn't running");
        }
    ...
    public class ServiceToActivity extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            mClientAddress = notificationData.getString("clientAddress");
            int mClientPortNumber = notificationData.getInt("clientThreadPortNumber");
            mSocket = new SocketHandler().getSocket();

            // Message from the service
            actionType.setText(mRole);
            clientAddress.setText(mClientAddress + ": " + mClientPortNumber);
    ...
    private class Consumer extends AsyncTask<Void, Void, String> {
        ...
        onPostExecute(String result) {
            ndnResponse.setText(result);
            mMessageToClient = result;
    ...
    private class SocketServerReplyThread extends Thread {
        ...
        public void run() {
            ...
            String msgReply = "Hello from  " + mLocalAddress + " " + mMessageToClient;
            ...
            try {
                ...
                printStream.close();
                msgToClient.setText(msgReply);

            } catch (IOException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
                msgToClient.setText("Something wrong! " + e.toString());
            }
        }
    }
    ...
    //PRODUCER
    private class Producer extends AsyncTask<Void, Void, String> {
